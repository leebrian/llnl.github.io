...
function draw_line_repoActivity(areaID, repoNameWOwner) {
  ...
  function drawGraph(data, areaID) {
    ...
    if (repoNameWOwner == null) {
      ...
      graphHeader =
        "Activity for '" + repoNameWOwner + "' [Default Branch, 1 Year]";
    }
    ...
    var margin = {
        top: stdMargin.top,
        right: stdMargin.right,
        bottom: stdMargin.bottom,
        left: stdMargin.left * 1.15
      },
  ...
  function reformatData(obj) {
    ...
    var dataTotals = {};
    var repos =
      repoNameWOwner == null ? Object.keys(obj["data"]) : [repoNameWOwner];
  ...
  function getYearDate(monthDayString, dToday) {
    ...
    if (
      d3.min([dToday, parseTime(thisYear + "-" + monthDayString)]) == dToday
    ) {
