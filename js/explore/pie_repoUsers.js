...
function draw_pie_repoUsers(areaID, repoNameWOwner) {
  ...
  function drawGraph(data, areaID) {
    ...
    var color = d3
      .scaleOrdinal()
      .range([d3.schemeCategory20c[0], d3.schemeCategory20c[1]]);
    ...
    var tip = d3
      ...
      .html(function(d) {
        ...
        return (
          ...
          units +
          " (" +
          d3.format(".0%")(d.data.count / dataTotalCount) +
          ")" +
          "<br>" +
          d.data.label
        );
  ...
  function reformatData(objLabUsers, objExtUsers) {
    var repoContribs = function(objUsers) {
      ...
      users.forEach(function(user) {
        if (
          objUsers["data"].hasOwnProperty(user) &&
          objUsers["data"][user].hasOwnProperty("contributedLabRepositories")
        ) {
          var labRepos =
            objUsers["data"][user]["contributedLabRepositories"]["nodes"];
    ...
    var data = [
      ...
      { label: "CDCGov Members", count: labTotal }
    ];
    return data;
  }
}
